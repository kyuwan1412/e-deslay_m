...
class SKTMScreen extends StatefulWidget {
  ...
  @override
  State<SKTMScreen> createState() =>
      _SKTMScreenState();
}

class _SKTMScreenState
    extends State<SKTMScreen> {
  ...
  Future<void> submit() async {
    ...
    if (tanggunganC.text.trim().isEmpty) {

      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            "Jumlah tanggungan wajib diisi",
          ),
        ),
      );
    ...
    if (tujuanC.text.trim().isEmpty) {

      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            "Tujuan pengajuan wajib diisi",
          ),
        ),
      );
    ...
    if (fileKtp == null) {
      ...
      ScaffoldMessenger.of(context)
        ...
        const SnackBar(
          content: Text(
            "Upload foto KK terlebih dahulu",
          ),
        ),
      );
